...
void VJetEstimation::SetTTEffbq(std::vector<Double_t> Eff0bq, std::vector<Double_t> Eff1bq, std::vector<Double_t> Eff2bq, std::vector<Double_t> Eff3bq) {
 this->Eff0bq_ = Eff0bq ;
 this->Eff1bq_ = Eff1bq ;
 this->Eff2bq_ = Eff2bq ;
 this->Eff3bq_ = Eff3bq ;
...
Double_t VJetEstimation::Ntt_0bjet_e3(Double_t Ntt, Double_t eb, Double_t eudsc, Int_t n) {
	Double_t  Ntt_0bjet_ = ((1-eb)*(1-eb)*pow((1-eudsc),n-2)*GetTTEff2bq(n)
                         +         (1-eb)*pow((1-eudsc),n-1)*GetTTEff1bq(n)
                         +                pow((1-eudsc),n)  *GetTTEff0bq(n)
                                + (pow((1-eb),3)*pow((1-eudsc),n-3)) * GetTTEff3bq(n)
)*Ntt;
	return (Ntt_0bjet_ < 0 ? 0 : Ntt_0bjet_);
}
Double_t VJetEstimation::Ntt_1bjet_e3(Double_t Ntt, Double_t eb, Double_t eudsc, Int_t n) {
	Double_t  Ntt_1bjet_ =((2*eb*(1-eb)*pow(1-eudsc,n-2)+(1-eb)*(1-eb)*(n-2)*eudsc*pow(1-eudsc,n-3))*GetTTEff2bq(n)
                        +          (eb*pow(1-eudsc,n-1)+       (1-eb)*(n-1)*eudsc*pow(1-eudsc,n-2))*GetTTEff1bq(n)
                        +                                                (n*eudsc*pow(1-eudsc,n-1))*GetTTEff0bq(n)
                               + (3*eb*pow(1-eb,2)*pow(1-eudsc, n-3)
                                  +pow(1-eb,3)*(n-3)*pow(eudsc,1)*pow(1-eudsc,n-3-1)) * GetTTEff3bq(n)
)*Ntt;
	return (Ntt_1bjet_ < 0 ? 0 : Ntt_1bjet_);
}
Double_t VJetEstimation::Ntt_2bjets_e3(Double_t Ntt, Double_t eb, Double_t eudsc, Int_t n) {
	Double_t  Ntt_2bjets_ =((eb*eb*pow(1-eudsc,n-2)+2*eb*(1-eb)*(n-2)*eudsc*pow(1-eudsc,n-3)+(1-eb)*(1-eb)*((n-2)*(n-3)/2)*eudsc*eudsc*pow(1-eudsc,n-4))*GetTTEff2bq(n)
                         +                                 (eb*(n-1)*eudsc*pow(1-eudsc,n-2)+       (1-eb)*((n-1)*(n-2)/2)*eudsc*eudsc*pow(1-eudsc,n-3))*GetTTEff1bq(n)
                         +                                                                                   ((n*(n-1)/2)*eudsc*eudsc*pow(1-eudsc,n-2))*GetTTEff0bq(n)
                                + (3*pow(eb,2)*pow(1-eb,1)*pow(1-eudsc,n-3)
                                   +3*pow(eb,1)*pow(1-eb,2)*(n-3-1)*pow(eudsc,1)*pow(1-eudsc,n-3-1)
                                   +pow(1-eb,3)*((n-3)*(n-3-1)/2)*pow(eudsc,2)*pow(1-eudsc,n-3-2)) * GetTTEff3bq(n)
)*Ntt;
	return (Ntt_2bjets_<0 ? 0 : Ntt_2bjets_);
}
Double_t VJetEstimation::Ntt_3bjets_e3(Double_t Ntt, Double_t eb, Double_t eudsc, Int_t n) {
  Double_t  Ntt_3bjets_ =((eb*eb*(n-2)*eudsc*pow(1-eudsc,n-3)+2*eb*(1-eb)*((n-2)*(n-3)/2)*eudsc*eudsc*pow(1-eudsc,n-4)+(n>4 ? pow((1-eb),2)*((n-2)*(n-3)*(n-4)/6)*pow(eudsc,3)*pow((1-eudsc),n-5) : 0 ))*GetTTEff2bq(n)
                          +                                              (eb*((n-1)*(n-2)/2)*eudsc*eudsc*pow(1-eudsc,n-3)+ (1-eb)*((n-1)*(n-2)*(n-3)/6)*pow(eudsc,3)*pow(1-eudsc,n-4))*GetTTEff1bq(n)
                          +                                                                                                          ((n*(n-1)*(n-2)/6)*pow(eudsc,3)*pow(1-eudsc,n-3))*GetTTEff0bq(n)
                          + (pow(eb,3)*pow(1-eudsc,n-3)
                             +3*pow(eb,2)*pow(1-eb,1)*(n-3)*pow(eudsc,1)*pow(1-eudsc,n-3-1)
                             +3*pow(eb,1)*pow(1-eb,2)*((n-3)*(n-4)/2)*pow(eudsc,2)*pow(1-eudsc,n-3-2)
                             +pow(1-eb,3)*((n-3)*(n-4)*(n-5)/6)*pow(eudsc,3)*pow(1-eudsc,n-3-3)) * GetTTEff3bq(n)
)*Ntt;
  return (Ntt_3bjets_<0 ? 0 : Ntt_3bjets_);
}
